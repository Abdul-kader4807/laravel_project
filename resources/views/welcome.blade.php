...
@section('page_content')
    @php
        // $total_orders = DB::select('SELECT sum(total_order) total FROM phar_orders');
        // $total_orders_paid = DB::select('SELECT sum(paid_amount) total FROM phar_orders');
        // $total_orders_no = DB::select('SELECT count(*) as total FROM phar_orders');

        $total_orders = DB::table('orders')->sum('total_order');
        $total_orders_paid = DB::table('orders')->sum('paid_amount');
        $total_orders_discount = DB::table('orders')->sum('discount');
        $total_orders_no = DB::table('orders')->count();

        $total_purchase = DB::table('purchases')->sum('total_purchase');
        $total_purchase_paid = DB::table('purchases')->sum('paid_amount');
        $total_purchase_discount = DB::table('purchases')->sum('discount');
        $total_purchase_no = DB::table('purchases')->count();

        $total_customers = DB::table('customers')->count();
        $total_suppliers = DB::table('suppliers')->count();
        $total_warehouse = DB::table('warehouse')->count();
        $total_stock = DB::table('stock')->sum('qty');
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h4 class="my-1 text-danger">{{ $total_orders_paid }}</h4>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0 border-4 border-danger">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Total Discount </p>
                            <h4 class="my-1 text-danger">{{ $total_orders_discount }}</h4>
                            <p class="mb-0 font-13">+5.4% from last week</p>
                        </div>
                        <div class="widgets-icons-2 rounded-circle bg-gradient-burning text-white ms-auto"><i
                                class='bx bxs-wallet'></i>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0 border-4 border-success">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Total Orders Count</p>
                            <h4 class="my-1 text-success">{{ $total_orders_no }}</h4>
            ...
            <div class="card radius-10 border-start border-0 border-4 border-danger">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Total Revenue</p>
                            <h4 class="my-1 text-danger">{{ $total_purchase_paid }}</h4>
                            <p class="mb-0 font-13">+5.4% from last week</p>
                        </div>
                        <div class="widgets-icons-2 rounded-circle bg-gradient-burning text-white ms-auto"><i
                                class='bx bxs-wallet'></i>
            ...
            <div class="card radius-10 border-start border-0 border-4 border-danger">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Total Discount </p>
                            <h4 class="my-1 text-danger">{{ $total_purchase_discount }}</h4>
                            <p class="mb-0 font-13">+5.4% from last week</p>
                        </div>
                        <div class="widgets-icons-2 rounded-circle bg-gradient-burning text-white ms-auto"><i
                                class='bx bxs-wallet'></i>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0 border-4 border-success">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Total Purchase Count</p>
                            <h4 class="my-1 text-success">{{ $total_purchase_no }}</h4>
                            <p class="mb-0 font-13">-4.5% from last week</p>
                        </div>
                        <div class="widgets-icons-2 rounded-circle bg-gradient-ohhappiness text-white ms-auto"><i
                                class='bx bxs-bar-chart-alt-2'></i>
               ...
               <div class="card-body">
                   <div class="d-flex align-items-center">
                       <div>
                           ...
                           <h4 class="my-1 text-warning">{{$total_stock}}</h4>
                           <p class="mb-0 font-13">+8.4% from last week</p>
                       </div>
                       <div class="widgets-icons-2 rounded-circle bg-gradient-orange text-white ms-auto"><i class='bx bx-box'></i>
                       </div>
                   </div>
               </div>
            </div>
               ...
               <div class="card-body">
                   <div class="d-flex align-items-center">
                       <div>
                           ...
                           <h4 class="my-1 text-warning">{{$total_suppliers}}</h4>
                           <p class="mb-0 font-13">+8.4% from last week</p>
                       </div>
                       <div class="widgets-icons-2 rounded-circle bg-gradient-orange text-white ms-auto"><i class='fa fa-truck'></i>
                       </div>
                   </div>
               </div>
            </div>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-4 border-warning">
                   <div class="card-body">
                       <div class="d-flex align-items-center">
                           <div>
                               <p class="mb-0 text-secondary">Total Warehouse</p>
                               <h4 class="my-1 text-warning">{{$total_warehouse}}</h4>
                               <p class="mb-0 font-13">+8.4% from last week</p>
                           </div>
                           <div class="widgets-icons-2 rounded-circle bg-gradient-orange text-white ms-auto"><i class='bx bx-store'></i>
                           </div>
                       </div>
                   </div>
                </div>

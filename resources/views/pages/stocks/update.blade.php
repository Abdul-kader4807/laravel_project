    ...
    <div class="card-body p-4">
        <form action="{{ url('stock'. $stock->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="position-relative input-icon">
                        ...
                        <span class="position-absolute top-50 start-0 ps-2 translate-middle-y"><i
                                class='bx bx-package'></i></sp>
                    </div>
                    @error('product_id')
            ...
            {{-- <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="number" class="form-control"  name="offer_price" value="{{ $stock['offer_price'] }}" placeholder="Enter Offer Price (Optional)">
                </div>
            </div> --}}
    ...
    <div class="col-sm-9 position-relative">
        ...
        @enderror
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" name="remark" rows="3" placeholder="Additional Remarks (Optional)">{{ $stock['remark'] }}</textarea>
                </div>
            </div>

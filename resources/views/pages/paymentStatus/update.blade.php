...
@php
 ...
 @endphp
    ...
    <div class="row">
        <div class="col-6">
            <h4 class="mb-3 btn btn-secondary px-4">Update payment_status</h4>
        </div>


        <div class="d-md-flex d-grid align-items-center gap-3 d-flex justify-content-end mb-2 col-6">
            <a class="btn btn-success" href="{{ url('payment_status') }}">Back</a>
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            ...
            <form action="{{url("payment_status/{$payment_status['id']}")}}" method="post" enctype="multipart/form-data">
                @csrf
                    {{-- @method('PUT') --}}
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="position-relative input-icon">
                            <input type="text" class="form-control" name="name" value="{{$payment_status['name']}}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" name="description" id="input47" rows="3" placeholder="description">{{$payment_status['description']}}</textarea>
                        </div>
                        @error('description')
                            <span style="color: red">{{ $message }}</span>
                        @enderror

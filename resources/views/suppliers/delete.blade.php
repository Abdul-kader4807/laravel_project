 ...
 @endphp
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            ...
            <form action="{{url('supplier/delete')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-sm-9">
                        <div class="position-relative input-icon">
                            <input type="text" name="contact_person" value="{{$supplier['contact_person']}}" class="form-control"
                                id="input43" placeholder="contact_person">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="position-relative input-icon">
                            <img width="50" height="" src="{{asset('photo')}}/{{$supplier['photo']}}" alt="{{$supplier['name']}}" srcset="">
